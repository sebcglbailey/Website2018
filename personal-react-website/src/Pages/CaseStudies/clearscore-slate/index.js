        ...
        <Info>
          <div className='cs-container'>
            <div className='cs-info'>
              ...
              Slate incorporates a vast array of design tokens in order to give fine-control over the branding and appearance of the components for each of our brands, allowing full styling flexibility, whilst providing standard and recognisable design patterns across our products and websites.</p>
              <div className='cs-image'>
              ...
              <p>Along with a fantastic team of engineers across all three platforms, and a Product Manager, I have not only delivered the designs and vision for the new Design System, but I have written documention, scoped delivery, project managed, owned and analysed the impact and cost efficiencies of the system, rolled it out across a company of over 400 employees, written component schemas, helped with the styling in CSS of various components, onboarded designers and engineers into contributing back into the system, as well as use it, and presented successes and demonstrations to senior stakeholders across the group business.</p>
              <div className='cs-image'>
              ...
              <p>Alongside our new Design System, I have played a pivotal part in leading a brand new initiative for Server-Driven UI. By aligning the schemas of our components for all platforms and building a bespoke API for creating UIs from one source-of-truth, we are now able to launch and release completely new pages and UIs in our products without the need for a native release.<br /><br/>
              This frees up time for our client engineers to focus on building world-class UI and interactions, and allows our global markets to iterate and build new features without the need for client support – something which either took months before, or was actually impossible.</p>
              <div className='cs-image'>
