...
class Masonry extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.originalChildren !== this.state.originalChildren) {
      this.setState({ children: nextProps.children, originalChildren: nextProps.children, rendered: false })
    }
    if (nextProps.contentsLoaded !== this.state.contentsLoaded) {
    //   this.setState({ contentsLoaded: true })
      this.setState({ contentsLoaded: nextProps.contentsLoaded })
